// Path and File Name : /home/ransomeye/rebuild/ransomeye_linux_agent/src/config.rs
    ...
    pub fn load() -> Result<Self, ConfigError> {
        ...
        Ok(Config {
            ...
            buffer_dir: env::var("BUFFER_DIR")
                .unwrap_or_else(|_| "/var/lib/ransomeye/linux_agent/buffer".to_string()),
            cert_path: env::var("AGENT_CERT_PATH")
                .unwrap_or_else(|_| "/etc/ransomeye/certs/agent.crt".to_string()),
            key_path: env::var("AGENT_KEY_PATH")
                .unwrap_or_else(|_| "/etc/ransomeye/certs/agent.key".to_string()),
