// Path and File Name : /home/ransomeye/rebuild/ransomeye_dpi_probe/tests/integration_tests.rs
// Author: nXxBku0CKFAJCBN3X1g3bQk7OxYQylg8CMw1iGsq7gU
// Details of functionality of this file: Integration tests for DPI Probe - identity spoofing, event signing, backpressure, core unavailability, resource exhaustion

use std::sync::Arc;
use std::time::Duration;
use ransomeye_dpi_probe::*;
...
async fn test_event_signing() {
    ...
    assert_eq!(signed_event.data_hash, expected_hash);
}
...
async fn test_backpressure() {
    ...
    assert!(!backpressure.can_accept());
}
