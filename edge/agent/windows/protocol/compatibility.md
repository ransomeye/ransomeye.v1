# Windows Agent Protocol Compatibility

**Path and File Name:** `/home/ransomeye/rebuild/ransomeye_windows_agent/protocol/compatibility.md`  
**Author:** nXxBku0CKFAJCBN3X1g3bQk7OxYQylg8CMw1iGsq7gU  
**Details:** Protocol version compatibility and migration guide for Windows Agent telemetry events
...
- Registry event support

## Backward Compatibility

The Windows Agent protocol is designed to be forward-compatible. Core must accept events from any Windows Agent version and handle gracefully:
...
6. Verify registry event support

### Upgrading Core

When upgrading Core:
1. Ensure backward compatibility with v1.0 events
2. Test event reception from existing Windows Agents
3. Validate signature verification
4. Verify telemetry data parsing
5. Verify registry event parsing
...
- Registry event structure changes
